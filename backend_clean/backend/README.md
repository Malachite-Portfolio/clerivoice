...
- `PROFILE_IMAGE_PUBLIC_BASE_URL` (optional; example: `https://your-service-xyz.a.run.app`)
...
Set these before startup (local `.env` for dev, Cloud Run environment variables for production):
...
In Cloud Run service variables, set:
- `AGORA_APP_ID=d693b2cf2b9649d08f667a3d7a25011f`
...
- `JWT_ACCESS_SECRET`
- `JWT_REFRESH_SECRET`
- `CLIENT_ORIGIN=https://your-admin-domain.com,http://localhost:3000`
- Optional for uploaded profile image URLs:
  - `PROFILE_IMAGE_PUBLIC_BASE_URL=https://your-service-xyz.a.run.app`
